...
<body>
    ...
    <div id="divDebug">
        <div>
            <label>pizzaIdSelecionada(): </label><span data-bind="text: pizzaIdSelecionada()"></span>
        </div>
        <div data-bind="with: pizzaSelecionada">
            <label>pizzaSelecionada().Id: </label><span data-bind="text: Id"></span>
            <label>pizzaSelecionada().Nome: </label><span data-bind="text: Nome"></span>
            <label>pizzaSelecionada().Ingredientes().length: </label><span data-bind="text: Ingredientes().length"></span>
        </div>
    </div>
</body>
